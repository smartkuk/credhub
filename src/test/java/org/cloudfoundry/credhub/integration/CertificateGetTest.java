...
public class CertificateGetTest {
  ...
  public void getCertificateCredentials_returnsAllCertificateCredentials() throws Exception {
    generateCertificateCredential(mockMvc, "/user-a/first-certificate", CredentialWriteMode.OVERWRITE.mode, "test", null, USER_A_TOKEN);
    generateCertificateCredential(mockMvc, "/user-a/second-certificate", CredentialWriteMode.OVERWRITE.mode, "first-version", null, USER_A_TOKEN);
    generateCertificateCredential(mockMvc, "/user-a/second-certificate", CredentialWriteMode.OVERWRITE.mode, "second-version", null, USER_A_TOKEN);
    generatePassword(mockMvc, "/user-a/invalid-cert", CredentialWriteMode.OVERWRITE.mode, null, USER_A_TOKEN);
  ...
  public void getCertificateCredentialsByName_doesNotReturnOtherCredentialTypes() throws Exception {
    generatePassword(mockMvc, "my-credential", CredentialWriteMode.OVERWRITE.mode, 10, ALL_PERMISSIONS_TOKEN);
  ...
  public void getCertificateVersionsByCredentialId_returnsAllVersionsOfTheCertificateCredential() throws Exception {
    String firstResponse = generateCertificateCredential(mockMvc, "/first-certificate",
        CredentialWriteMode.OVERWRITE.mode, "test", null, ALL_PERMISSIONS_TOKEN);
  ...
  public void getCertificateVersionsByCredentialId_withCurrentTrue_returnsCurrentVersionsOfTheCertificateCredential()
    ...
    generateCertificateCredential(mockMvc, credentialName, CredentialWriteMode.OVERWRITE.mode, "test", null, ALL_PERMISSIONS_TOKEN);
