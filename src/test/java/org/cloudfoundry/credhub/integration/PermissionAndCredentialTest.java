...
public class PermissionAndCredentialTest {
  ...
  @Test
  public void put_withExistingCredentialAndAPermission_andOverwriteSetToTrue_itDoesUpdatePermissions() throws Exception {
  ...
  @Test
  public void put_withExistingCredentialAndAPermission_andOverwriteSetToFalse_itDoesNotUpdatePermissions() throws Exception {
    createExistingCredential();

    String requestBodyWithNewPermissions = "{\n"
        + "  \"type\":\"password\",\n"
        + "  \"name\":\"/test-password\",\n"
        + "  \"overwrite\":false, \n"
        + "  \"value\":\"ORIGINAL-VALUE\", \n"
    ...
    ResultActions response = mockMvc.perform(put("/api/v1/data")
        ...
        .accept(APPLICATION_JSON)
        .contentType(APPLICATION_JSON)
        .content(requestBodyWithNewPermissions));
    ...
    assertThat(acl.getPermissions(), contains(
        samePropertyValuesAs(
            new PermissionEntry(USER_A_ACTOR_ID, "/test-password", asList(READ, WRITE)))));
  }

  @Test
  public void post_withExistingCredentialAndAPermission_andOverwriteSetToFalse_itDoesNotUpdatePermissions() throws Exception {
    createExistingCredential();
